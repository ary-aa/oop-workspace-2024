...
int main() {
    ...
    std::cout << "2 \n";
    is_descending(array2, 4);

    int array3[3] = {-50, 160, 40}; //test out larger, mixed signs not ascending or descending
    std::cout << "3 \n";
    is_descending(array3, 3);

    int array4[3] = {45,-50,160}; //test out output if the size perameter is less than 1
    std::cout << "4 \n";
    is_descending(array4, 0);

    int array5[5] = {5,4,3,2,1}; //test out 5 descending positive integers
    std::cout << "5 \n";
    is_descending(array5, 5);
